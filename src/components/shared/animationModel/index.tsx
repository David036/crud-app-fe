...
export default function Butterfly() {
  return (
    ...
    c0.058,0.023,0.177-0.003,0.358-0.081"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
    ...
    c-0.707-0.021-1.308,0.59-1.226,1.314c0.005,0.047,0.01,0.095,0.016,0.142c0.146,1.277,2.176,1.467,2.337,0.1"
              />
              <path style={{ opacity: 0.25, fill: "#FFFFFF" }} />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M42.191,72.243c-2.578,0-2.182,3.992,0.384,3.992C45.153,76.234,44.757,72.243,42.191,72.243z"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
              ...
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M25.514,36.061c-1.595,0-1.91,2.492-0.295,2.492C26.814,38.553,27.129,36.061,25.514,36.061z"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M33.376,61.474c-1.237,0-2.44,1.016-2.413,2.311c0.027,1.257,0.991,2.413,2.312,2.413c1.237,0,2.44-1.016,2.413-2.311C35.661,62.629,34.696,61.474,33.376,61.474z"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M35.116,16.812c-1.552,0-1.267,2.404,0.277,2.404C36.945,19.215,36.66,16.812,35.116,16.812z"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M77.376,51.331c2.442,0,1.936-3.77-0.477-3.77C74.458,47.561,74.963,51.331,77.376,51.331z"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
              ...
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M53.266,34.617c0.824,0,1.694-0.446,1.77-1.371"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
              ...
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M55.757,99.48c-0.062,0-0.069,0.097-0.007,0.097"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
              ...
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M83.437,132.299c0,0.205,0.011,0.285,0.164,0.428"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
              ...
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M82.279,94.513c0.062,0,0.069-0.097,0.007-0.097"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
              ...
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M100.904,128.99c-1.151,0-2.121,1.31-1.964,2.402"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
              ...
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M53.242,59.583c-0.476,0-0.826,0.542-0.776,0.977"
              />
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
              ...
              <path
                style={{ opacity: 0.25, fill: "#FFFFFF" }}
                d="M76.1,126.199c-0.632-0.469-1.275-0.611-2.06-0.611"
              />
            </g>
            <path
              id="black"
